...
public class ChangeShaderFromInspectorEA : MonoBehaviour {
	...
	void ChangeStart(){
		...
		changeShader(targetGameObject, texture, mainTextureScaleX, mainTextureScaleY,amount, point, ShaderName_to);
		}
	}
...
/// <summary>
    ...
    public static void changeShader(GameObject targetGameObject, Texture texture, float mainTextureScaleX, float mainTextureScaleY, float amount, float point, string ShaderName_to, string ShaderName_from = "")
    {
			...
			if (t.GetComponent<Renderer>() != null)
            {
                ...
                for (int i = 0; i< materials.Length; i++) 
                {
                    ...
                    if (ShaderName_from == "")
                    {
	                    ...
	                    material.SetFloat("_ExtrusionPoint", point);
	                    material.SetTextureScale("_Albedo", new Vector2(mainTextureScaleX, mainTextureScaleY));
                    }
                    else
                    {	
